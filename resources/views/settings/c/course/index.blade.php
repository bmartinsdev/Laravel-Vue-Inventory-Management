...
<div id="definicoes" class="content">
	...
	<div id="searchbar">
		<form action="/definicoes/c/turmas" method="GET" role="search">
			<div class="row">
	...
	<div class="main">
		<div class="breadcrumb-holder d-flex">
			...
			<div class="flex-shrink-1 pt-2">
				<a class="grid-btn bgc-blue" href="{{ url('/definicoes/c/turmas/create') }}">Adicionar</a>
			</div>
	</div>
				...
				<thead>
					<tr>
						<th class="brdc-blue" scope="col">
							<a href="{{ route('turmas.index', ['order' => 'id']) }}" class="ftc-main">
								ID
								<i class="grid-sort"></i>
							</a>
						</th>
						<th class="brdc-blue">
							<a href="{{ route('turmas.index', ['order' => 'nome']) }}" class="ftc-main">
								Nome
								<i class="grid-sort"></i>
							</a>
						</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="d-flex justify-content-end">
							<a href="{{ url('/definicoes/c/turmas/' . $course->id . '/edit') }}">
								<i class="grid-editar btn-editar"></i>
							</a>
							<a onClick="abrirmodal({{ $course->id }})">
